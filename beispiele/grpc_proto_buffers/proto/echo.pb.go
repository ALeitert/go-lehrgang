...
const file_proto_echo_proto_rawDesc = "" +
	"\n" +
	"\x10proto/echo.proto\x12\x04echo\"2\n" +
	...
	"\vEchoService\x122\n" +
	"\bSayHello\x12\x12.echo.HelloRequest\x1a\x10.echo.HelloReply\"\x00B\x19Z\x17protobuff-example/protob\x06proto3"
...
var file_proto_echo_proto_depIdxs = []int32{
	0, // 0: echo.EchoService.SayHello:input_type -> echo.HelloRequest
	1, // 1: echo.EchoService.SayHello:output_type -> echo.HelloReply
